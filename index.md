...
- Kaiyi Chen, Qingbin Wang, and **Yutao Ma***. [Cervical Optical Coherence Tomography Image Classification Based on Contrastive Self-Supervised Texture Learning](https://doi.org/10.1002/mp.15630). _Medical Physics_, DOI: 10.1002/mp.15630, 2022. ([arXiv](https://arxiv.org/abs/2108.05081), [Code](https://github.com/whuchris/MIA-CTL))
- Hao Sun#, Xianxu Zeng#, Tao Xu, Gang Peng, and **Yutao Ma***. [Computer-Aided Diagnosis in Histopathological Images of the Endometrium Using a Convolutional Neural Network and Attention Mechanisms](https://ieeexplore.ieee.org/document/8854180). _IEEE Journal of Biomedical and Health Informatics_, 2020, 24(6): 1664-1676. ([Code](https://github.com/ssea-lab/DL4ETI))
  ...
  > - Bas H.M.van der Velden, Hugo J. Kuijf, Kenneth G.A. Gilhuijs, and [Max A.Viergever](https://www.umcutrecht.nl/en/Research/Researchers/Viergever-Max-A-MA). [Explainable artificial intelligence (XAI) in deep learning-based medical image analysis](https://doi.org/10.1016/j.media.2022.102470). _Medical Image Analysis_, DOI: 10.1016/j.media.2022.102470, 2022.
