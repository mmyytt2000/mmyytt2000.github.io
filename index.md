...
- Kaiyi Chen, Qingbin Wang, and **Yutao Ma***. [Cervical Optical Coherence Tomography Image Classification Based on Contrastive Self-Supervised Texture Learning](https://doi.org/10.1002/mp.15630). _Medical Physics_, 2022, 49(6): 3638-3653. ([arXiv](https://arxiv.org/abs/2108.05081), [Code](https://github.com/whuchris/MIA-CTL))
  ...
  > - Siladittya Manna, Saumik Bhattacharya, [Umapada Pal](https://www.isical.ac.in/~umapada/). [Self-Supervised Visual Representation Learning for Medical Image Analysis: A Comprehensive Survey](https://openreview.net/forum?id=3Wg1oErMcJ). _Transactions on Machine Learning Research_, 2024.
- Hao Sun#, Xianxu Zeng#, Tao Xu, Gang Peng, and **Yutao Ma***. [Computer-Aided Diagnosis in Histopathological Images of the Endometrium Using a Convolutional Neural Network and Attention Mechanisms](https://ieeexplore.ieee.org/document/8854180). _IEEE Journal of Biomedical and Health Informatics_, 2020, 24(6): 1664-1676. ([Code](https://github.com/ssea-lab/DL4ETI))
  ...
  > - Bas H.M.van der Velden, Hugo J. Kuijf, Kenneth G.A. Gilhuijs, and [Max A. Viergever](https://www.umcutrecht.nl/en/Research/Researchers/Viergever-Max-A-MA). [Explainable artificial intelligence (XAI) in deep learning-based medical image analysis](https://doi.org/10.1016/j.media.2022.102470). _Medical Image Analysis_, 2022, 79: 102470.
...
- **Yutao Ma#**, Tao Xu#, Xiaolei Huang, Xiaofang Wang, Canyu Li, Jason Jerwick, Yuan Ning, Xianxu Zeng, Baojin Wang, Yihong Wang, Zhan Zhang, Xiaoan Zhang, and Chao Zhou*. [Computer-Aided Diagnosis of Label-Free 3-D Optical Coherence Microscopy Images of Human Cervical Tissue](https://ieeexplore.ieee.org/document/8598821). _IEEE Transactions on Biomedical Engineering_, 2019, 66(9): 2447-2456.
  ...
  > - [Rebecca Richards-Kortum](https://profiles.rice.edu/faculty/rebecca-richards-kortum), Cesaltina Lorenzoni, [Vanderlei S. Bagnato](https://engineering.tamu.edu/biomedical/profiles/bagnato-vanderlei.html), and Kathleen Schmeler. [Optical imaging for screening and early cancer diagnosis in low-resource settings](https://doi.org/10.1038/s44222-023-00135-4). _Nature Reviews Bioengineering_, 2024, 2: 25-43.
  > - Philippa Kadama-Makanga, Aggrey Semeere, Miriam Laker-Oketta, et al. [Usability of a smartphone-compatible, confocal micro-endoscope for cervical cancer screening in resource-limited settings](https://doi.org/10.1186/s12905-024-03323-5). _BMC Women's Health_, 2024, 24: 483.
- Xianxu Zeng#, Xiaoan Zhang#, Canyu Li, Xiaofang Wang, Jason Jerwick, Tao Xu, Yuan Ning, Yihong Wang, Linlin Zhang, Zhan Zhang, **Yutao Ma**, and Chao Zhou*. [Ultrahigh-resolution optical coherence microscopy accurately classifies precancerous and cancerous human cervix free of labeling](https://www.thno.org/v08p3099.htm). _Theranostics_, 2018, 8(11): 3099-3110. (**[Front-Cover Article](https://www.thno.org/v8i11)**)
  ...
  > - [Rebecca Richards-Kortum](https://profiles.rice.edu/faculty/rebecca-richards-kortum), Cesaltina Lorenzoni, [Vanderlei S. Bagnato](https://engineering.tamu.edu/biomedical/profiles/bagnato-vanderlei.html), and Kathleen Schmeler. [Optical imaging for screening and early cancer diagnosis in low-resource settings](https://doi.org/10.1038/s44222-023-00135-4). _Nature Reviews Bioengineering_, 2024, 2: 25-43.
  > - Zilong Wang, Jiaying Yu, Wenli Zhu, et al. [Unveiling the mysteries of extrachromosomal circular DNA: from generation to clinical relevance in human cancers and health](https://doi.org/10.1186/s12943-024-02187-5). _[Molecular Cancer](https://molecular-cancer.biomedcentral.com/)_, 2024, 23: 276.
...
- Chao Zhou*, Aneesh Alex, Janarthanan Rasakanthan, and **Yutao Ma**. [Space-division multiplexing optical coherence tomography](https://www.osapublishing.org/oe/abstract.cfm?uri=oe-21-16-19219). _Optics Express_, 2013, 21(16): 19219-19227.
  > - Hee Yoon Lee, Helge Sudkamp, Tahereh Marvdashti, and [Audrey K. Ellerbee](https://en.wikipedia.org/wiki/Audrey_Ellerbee_Bowden). [Interleaved optical coherence tomography](https://doi.org/10.1364/OE.21.026542). _Optics Express_, 2013, 21(22): 26542-26556.
  ...
  > - Biwei Yin, Jordan Dwelle, Bingqing Wang, Tianyi Wang, Marc D. Feldman, Henry G. Rylander, and [Thomas E. Milner](http://www.bli.uci.edu/tom-milner-ph-d/). [Fourier optics analysis of phase-mask-based path-length-multiplexed optical coherence tomography](https://doi.org/10.1364/JOSAA.32.002169). _Journal of the Optical Society of America A_, 2015,  32(11): 2169-2177.
  ...
  > - Thomas Klein and [Robert Huber](https://www.bmo.uni-luebeck.de/en/staff/staff/huber-robert). [High-speed OCT light sources and systems](https://doi.org/10.1364/BOE.8.000828). _Biomedical Optics Express_, 2017, 8(2): 828-859.
  ...
  > - Jungho Moon, Yong-Sik Lim, Seokchan Yoon, and [Wonshik Choi](https://en.wikipedia.org/wiki/Choi_Wonshik). [Single-shot multi-depth full-field optical coherence tomography using spatial frequency division multiplexing](https://doi.org/10.1364/OE.417950). _Optics Express_, 2021, 29(5): 7060-7069.
  ...
  > - Karol Karnowski, Jadwiga Milkiewicz, Angela Pachacz, Andrea Curatolo, Onur Cetinkaya, Rafal Pietruch, Piotr Ciacka, Ashkan Eliasy, Ahmed Abass, Ahmed Elsheikh, Susana Marcos, and [Maciej Wojtkowski](https://en.wikipedia.org/wiki/Maciej_Wojtkowski). [Air puff-coupled multi-spot OCT for assessment of asymmetries in corneal biomechanics](https://doi.org/10.1117/12.2609511). _Proceedings of SPIE_, 2022, 11941: 119410U.

### Service Recommendation and Service-based System Development

- **Yutao Ma**, Zesheng Wang, Liwei Huang, and Jian Wang*. [CLHHN: Category-aware Lossless Heterogeneous Hypergraph Neural Network for Session-based Recommendation](https://doi.org/10.1145/3626569). _ACM Transactions on the Web_, 2024, 18(1): 12:1-12:37. ([Code](https://github.com/ssea-lab/CLHHN))
...
- Liwei Huang, **Yutao Ma***, Yanbo Liu, Bohong (Danny) Du, Shuliang Wang, and Deyi Li. [Position-enhanced and Time-aware Graph Convolutional Network for Sequential Recommendations](https://doi.org/10.1145/3511700). _ACM Transactions on Information Systems_, 2023, 41(1): 6:1-6:32. ([arXiv](https://arxiv.org/abs/2107.05235), [Code](https://github.com/drhuangliwei/PTGCN))
  ...
  > - Jingyu Gao, Chaohuan Hou ([候朝焕院士](http://casad.cas.cn/sourcedb_ad_cas/zw2/ysxx/xxjskxb/200906/t20090624_1807806.html)), and Sancong Ying. [DraG4Rec: A Symmetrical View of User Preference and Item Popularity](http://dx.doi.org/10.36227/techrxiv.21540315). _TechRxiv_, 21540315, 2022.
  > - Jingyu Gao, Chaohuan Hou ([候朝焕院士](http://casad.cas.cn/sourcedb_ad_cas/zw2/ysxx/xxjskxb/200906/t20090624_1807806.html)), and Sancong Ying. [Edge-view Dual Message Carriers GCN for Sequential Recommendation](http://dx.doi.org/10.36227/techrxiv.22291393.v1). _TechRxiv_, 22291393, 2023.
  > - Haoyang Li, Ziwei Zhang, Xin Wang, and [Wenwu Zhu](https://www.cs.tsinghua.edu.cn/csen/info/1161/4012.htm). [Invariant Node Representation Learning under Distribution Shifts with Multiple Latent Environments](https://doi.org/10.1145/3604427). _ACM Transactions on Information Systems_, 2024, 42(1): 26:1-26:30.
- Liwei Huang, **Yutao Ma***, Shibo Wang, and Yanbo Liu. [An Attention-based Spatiotemporal LSTM Network for Next POI Recommendation](https://ieeexplore.ieee.org/document/8723186). _IEEE Transactions on Services Computing_, 2021, 14(6): 1585-1597. ([Code](https://github.com/drhuangliwei/An-Attention-based-Spatiotemporal-LSTM-Network-for-Next-POI-Recommendation), **included in [LibCity](https://libcity.ai/)**)
  ...
  > - Chenwang Zheng, Dan Tao, Jiangtao Wang, Lei Cui, Wenjie Ruan, and [Shui Yu](https://profiles.uts.edu.au/Shui.Yu). [Memory Augmented Hierarchical Attention Network for Next Point-of-Interest Recommendation](https://doi.org/10.1109/TCSS.2020.3036661). _IEEE Transactions on Computational Social Systems_, 2021, 8(2): 489-499.
  > - Zhiwei Guo, Keping Yu, Ali Kashif Bashir, Di Zhang, Yasser D. Al-Otaibi, and [Mohsen Guizani](https://mbzuai.ac.ae/study/faculty/professor-mohsen-guizani). [Deep Information Fusion-Driven POI Scheduling for Mobile Social Networks](https://doi.org/10.1109/MNET.102.2100394). _IEEE Network_, 2022, 36(4): 210-216.
  > - Zhiwei Guo, Keping Yu, Neeraj Kumar, Wei Wei, [Shahid Mumtaz](https://www.ntu.ac.uk/staff-profiles/science-technology/shahid-mumtaz), and [Mohsen Guizani](https://mbzuai.ac.ae/study/faculty/professor-mohsen-guizani/). [Deep-Distributed-Learning-Based POI Recommendation Under Mobile-Edge Networks](https://doi.org/10.1109/JIOT.2022.3202628). _IEEE Internet of Things Journal_, 2023, 10(1): 303-317.
  ...
  > - Hanrui Wu, Chung Wang Wong, Jia Zhang, Yuguang Yan, Dahai Yu, Jinyi Long, and [Michael Ng](https://hkumath.hku.hk/~mng/). [Cold-start Next-item Recommendation by User-Item Matching and Auto-encoders](https://doi.org/10.1109/TSC.2023.3237638). _IEEE Transactions on Services Computing_, 2023, 16(4): 2477-2489.
  ...
  > - Zhaobo Wang, Yanmin Zhu, Chunyang Wang, Wenze Ma, [Bo Li](https://cse.hkust.edu.hk/faculty/bli/), and Jiadi Yu. [Adaptive Graph Representation Learning for Next POI Recommendation](https://doi.org/10.1145/3539618.3591634). In _Proceedings of the 46th International ACM SIGIR Conference on Research and Development in Information Retrieval (SIGIR 2023)_, pp. 393–402, 2023.
  > - Jinze Wang, Lu Zhang, Zhu Sun, and [Yew-Soon Ong](https://www3.ntu.edu.sg/home/asysong/home.html). [Meta-learning Enhanced Next POI Recommendation by Leveraging Check-ins from Auxiliary Cities](https://doi.org/10.1007/978-3-031-33380-4_25). In _Proceedings of the 27th Pacific-Asia Conference on Knowledge Discovery and Data Mining (PAKDD 2023)_, pp. 322-334, 2023.
...
- Neng Zhang, Jian Wang*, and **Yutao Ma**. [Mining Domain Knowledge on Service Goals From Textual Service Descriptions](https://ieeexplore.ieee.org/document/7896653). _IEEE Transactions on Services Computing_, 2020, 13(3): 488-502.
  ...
  > - Haozhe Lin, Yushun Fan, Jia Zhang, Bing Bai, Zhenghua Xu, and Thomas Lukasiewicz. [Toward Knowledge as a Service (KaaS): Predicting Popularity of Knowledge Services Leveraging Graph Neural Networks](https://doi.org/10.1109/TSC.2022.3145019). _IEEE Transactions on Services Computing_, 2023, 16(1): 642-655.
- Ruibin Xiong, Jian Wang*, Neng Zhang, and **Yutao Ma**. [Deep Hybrid Collaborative Filtering for Web Service Recommendation](https://www.sciencedirect.com/science/article/pii/S0957417418303385). _Expert Systems with Applications_, 2018, 110: 191-205.
  > - Ignacio Lizarralde, Cristian Mateos, Alejandro Zunino, Tim A. Majchrzak, and Tor-Morten Grønli. [Discovering web services in social web service repositories using deep variational autoencoders](https://doi.org/10.1016/j.ipm.2020.102231). _Information Processing & Management_, 2020, 57(4): 102231.
  ...
  > - Haiyang Zhang, Ivan Ganchev, Nikola S. Nikolov, Zhanlin Ji, and [Mairtin O'Droma](https://www.ul.ie/research/emeritus-sl-m%C3%A1irt%C3%ADn-%C3%B3-droma). [FeatureMF: An Item Feature Enriched Matrix Factorization Model for Item Recommendation](https://doi.org/10.1109/ACCESS.2021.3074365). _IEEE Access_, 2021, 9: 65266-65276.
  > - Zhen Wang, Chang-Ai Sun, and [Marco Aiello](http://aiellom.it/). [Context-aware IoT Service Recommendation: A Deep Collaborative Filtering-based Approach](https://doi.org/10.1109/ICWS55610.2022.00035). In _Proceedings of the 29th IEEE International Conference on Web Services (ICWS 2022)_, pp. 150-159, 2022.
- Neng Zhang, Jian Wang*, **Yutao Ma**, Keqing He, Zheng Li, and Xiaoqing Liu. [Web service discovery based on goal-oriented query expansion](https://www.sciencedirect.com/science/article/pii/S0164121218300748). _Journal of Systems and Software_, 2018, 142: 73-91.
  > - Neha Agarwal, Geeta Sikka, and Lalit Kumar Awasthi. [A systematic literature review on web service clustering approaches to enhance service discovery, selection and recommendation](https://doi.org/10.1016/j.cosrev.2022.100498). _Computer Science Review_, 2022, 45: 100498.
  > - Javier Criado and Luis Iribarne. [Reusability and discovery models in software systems: a systematic literature review](http://dx.doi.org/10.5381/jot.2022.21.4.a3). _Journal of Object Technology_, 2022, 21(4): 3.
  > - Le Sun, Rui Zhou, Dandan Peng, [Athman Bouguettaya](https://www.sydney.edu.au/engineering/about/our-people/academic-staff/athman-bouguettaya.html), and Yanchun Zhang. [Automatically Building Service-Based Systems With Function Relaxation](https://doi.org/10.1109/TCYB.2022.3164767). _IEEE Transactions on Cybernetics_, 2023, 53(5): 2703-2716.
- Bo Hu, **Yutao Ma***, Liang-Jie Zhang, Chunxiao Xing, Jun Zou, and Ping Xu. [A CCRA based Mass Customization Development for Cloud Services](https://ieeexplore.ieee.org/document/6649760). In _Proceedings of the 2013 IEEE International Conference on Services Computing (IEEE SCC 2013)_, pp. 705-712, 2013.
  > Mehdi Bahrami and [Mukesh Singhal](https://cloudlab.ucmerced.edu/people/~mukesh). [DCCSOA: A Dynamic Cloud Computing Service-Oriented Architecture](https://ieeexplore.ieee.org/document/7300969). In _Proceedings of the 2015 IEEE International Conference on Information Reuse and Integration (IEEE IRI 2015)_, pp. 158-165, 2015.
- Yuchao Liu*, **Yutao Ma**, Haisu Zhang, Deyi Li, and Guisheng Chen. [A Method for Trust Management in Cloud Computing: Data Coloring by Cloud Watermarking](http://link.springer.com/article/10.1007/s11633-011-0583-3). _International Journal of Automation and Computing_, 2011, 8(3): 280-285. (**[Most highly accessed articles in 2013-2014 on SpringerLink](http://www.ijac.net/news/IJACAwards/80e3d06d-7735-4fc1-bf7c-9df781268a0e_en.htm)**)
  > - Dengguo Feng ([冯登国院士](http://casad.cas.cn/sourcedb_ad_cas/zw2/ysxx/xxjskxb/201911/t20191121_4724697.html)), Min Zhang, and Hao Li. [Big Data Security and Privacy Protection](http://cjc.ict.ac.cn/online/onlinepaper/fdg-2014115102415.pdf). _Chinese Journal of Computers_ 2014, 37(1): 246-258. (in Chinese with English Abstract)
  > - Arezou Soltani Panah, Ron G. van Schyndel, [Timos K. Sellis](https://www.swinburne.edu.au/research-institutes/data-science/people/timos-sellis/), and [Elisa Bertino](https://www.cs.purdue.edu/people/faculty/bertino/). [On the Properties of Non-Media Digital Watermarking: A Review of State of the Art Techniques](https://doi.org/10.1109/ACCESS.2016.2570812). _IEEE Access_, 2016, 4: 2670-2704.
...
- Feng Wang, Jinxiao Huang, and **Yutao Ma***. [A Top-k Learning to Rank Approach to Cross-Project Software Defect Prediction](https://ieeexplore.ieee.org/document/8719520). In _Proceedings of the 25th Asia-Pacific Software Engineering Conference (APSEC 2018)_, pp. 335-344, 2018. ([Dataset](https://github.com/ssea-lab/PROMISE))
  > Sourabh Pal and Alberto Sillitti. [Cross-Project Defect Prediction: A Literature Review](https://doi.org/10.1109/ACCESS.2022.3221184). _IEEE Access_, 2022, 10: 118697-118717.
- Hongrun Wu, Haiyang Liu, and **Yutao Ma***. [Empirical study on developer factors affecting tossing path length of bug reports](https://ieeexplore.ieee.org/document/8371790/). _IET Software_, 2018, 12(3): 258-270. ([Project](https://github.com/ssea-lab/BugTriage))
  ...
  > - Ali Sajedi Badashian and Eleni Stroulia. [Investigating the information value of different sources of evidence of developers' expertise for bug assignment in open-source projects](https://doi.org/10.1049/iet-sen.2019.0384). _IET Software_, 2020, 14(7): 748-758.
...
- Guoan You and **Yutao Ma***. [A Ranking-Oriented Approach to Cross-Project Software Defect Prediction: An Empirical Study](http://ksiresearchorg.ipage.com/seke/seke16paper/seke16paper_47.pdf). In _Proceedings of the 28th International Conference on Software Engineering and Knowledge Engineering (SEKE 2016)_, pp. 159-164, 2016. (**Best Paper Award**, [Journal Version](https://www.worldscientific.com/doi/abs/10.1142/S0218194016400155))
...
- Peng He, Bing Li, Xiao Liu, Jun Chen, and **Yutao Ma***. [An Empirical Study on Software Defect Prediction with a Simplified Metric Set](https://www.sciencedirect.com/science/article/pii/S0950584914002523). _Information and Software Technology_, 2015, 59: 170–190. (**[Most Cited IST Articles published since 2015](https://scholar.google.ca/citations?hl=en&vq=eng_softwaresystems&view_op=list_hcore&venue=pElyisFMojYJ.2020)**)
  ...
  > - Jinfu Chen, Weiyi Shang, and Emad Shihab. [PerfJIT: Test-level Just-in-time Prediction for Performance Regression Introducing Commits](https://doi.org/10.1109/TSE.2020.3023955). _IEEE Transactions on Software Engineering_, 2022, 48(5): 1529-1544.
...
- Peng He, Bing Li, and **Yutao Ma**. [Towards Cross-Project Defect Prediction with Imbalanced Feature Sets](https://arxiv.org/abs/1411.4228). _Computing Research Repository (CoRR)_, arXiv: 1411.4228, 2014.
  ...
  > - Yarong Zeng, Yue Yu, Qiang Fan, Xunhui Zhang, Tao Wang, Gang Yin, and Huaimin Wang ([王怀民院士](http://www.casad.cas.cn/sourcedb_ad_cas/zw2/ysxx/xxjskxb/201911/t20191121_4724699.html)). [Cross-Project Issue Classification Based on Ensemble Modeling in a Social Coding World](https://link.springer.com/chapter/10.1007/978-3-030-04212-7_24). In _Proceedings of the 25th International Conference on Neural Information Processing (ICONIP 2018)_, Part IV, pp. 281-292, 2018.
  > - Yuming Zhou, Yibiao Yang, Hongmin Lu, _et al_. [How Far We Have Progressed in the Journey? An Examination of Cross-Project Defect Prediction](https://dl.acm.org/doi/10.1145/3183339). _ACM Transactions on Software Engineering and Methodology_, 2018, 27(1): 1:1-1:51.
  ...
  > - Pravas Ranjan Bal and Sandeep Kumar. [A Data Transfer and Relevant Metrics Matching based Approach for Heterogeneous Defect Prediction](https://doi.org/10.1109/TSE.2022.3173678). _IEEE Transactions on Software Engineering_, 2023, 49(3): 1232-1245.
...
- Weifeng Pan*, Bing Li, Jing Liu, **Yutao Ma**, and Bo Hu. [Analyzing the structure of Java software systems by weighted k-core decomposition](https://www.sciencedirect.com/science/article/pii/S0167739X17320940). _Future Generation Computer Systems_, 2018, 83: 431-444.
  ...
  > - Qusay Alsarhan, Bestoun S. Ahmed, Miroslav Bures, and Kamal Zuhairi Zamli. [Software Module Clustering: An In-Depth Literature Analysis](https://doi.org/10.1109/TSE.2020.3042553). _IEEE Transactions on Software Engineering_, 2022, 48(6): 1905-1928.
- Weifeng Pan, Bing Li*, **Yutao Ma**, and Jing Liu. [Multi-granularity evolution analysis of software using complex network theory](https://link.springer.com/article/10.1007/s11424-011-0319-z). _Journal of Systems Science and Complexity_, 2011, 24(6): 1068-1082.
  > - Yu Qu, Xiaohong Guan ([管晓宏院士](http://www.xjtu.edu.cn/jsnr.jsp?urltype=tree.TreeTempUrl&wbtreeid=1632&wbwbxjtuteacherid=502)), Qinghua Zheng ([郑庆华院士](https://www.cae.cn/cae/html/main/colys/95010324.html)), et al. [Exploring community structure of software Call Graph and its applications in class cohesion measurement](https://www.sciencedirect.com/science/article/pii/S0164121215001259). _Journal of Systems and Software_, 2015, 108: 193-210.
  > - Michael Aram and Gustaf Neumann. [Multilayered analysis of co-development of business information systems](https://doi.org/10.1186/s13174-015-0030-8). _Journal of Internet Services and Applications_, 2015, 6(1): 13:1-13:30.
  ...
  > - Drew A. Vecchio, Samuel H. Mahler, Mark D. Hammig, and [Nicholas A. Kotov](https://che.engin.umich.edu/people/kotov-nicholas/). [Structural Analysis of Nanoscale Network Materials Using Graph Theory](https://doi.org/10.1021/acsnano.1c04711). _ACS Nano_, 2021, 15(8): 12847-12859. 
...
- Weifeng Pan, Bing Li*, **Yutao Ma**, Yeyi Qin, and Xiaoyan Zhou. [Measuring structural quality of object-oriented softwares via bug propagation analysis on weighted software networks](https://link.springer.com/article/10.1007/s11390-010-9399-9). _Journal of Computer Science and Technology_, 2010, 25(6): 1202-1213.
  > - Ivana Turnu, Giulio Concas, Michele Marchesi, and Roberto Tonelli. [The fractal dimension of software networks as a global quality metric](https://doi.org/10.1016/j.ins.2013.05.014). _Information Sciences_, 2013, 245: 290-303.
  > - Sara Abbaspour Asadollah, Daniel Sundmark, Sigrid Eldh, Hans Hansson, and Eduard Paul Enoiu. [A Study of Concurrency Bugs in an Open Source Software](https://doi.org/10.1007/978-3-319-39225-7_2). In _Proceedings of the 12th IFIP WG 2.13 International Conference on Open Source Systems: Integrating Communities (OSS 2016)_, pp. 16-31, 2016.
  > - An Zeng, Zhesi Shen, Jianlin Zhou, Jinshan Wu, Ying Fan, Yougui Wang, and [H. Eugene Stanley](https://en.wikipedia.org/wiki/H._Eugene_Stanley). [The science of science: From the perspective of complex systems](https://www.sciencedirect.com/science/article/pii/S0370157317303289). _[Physics Reports](https://www.sciencedirect.com/journal/physics-reports)_, 2017, 714–715: 1-73.
...
- **Yutao Ma**, Keqing He, Dehui Du, Jing Liu, and Yulan Yan. [A Complexity Metrics Set for Large-Scale Object-Oriented Software Systems](https://ieeexplore.ieee.org/document/4019967). In _Proceedings of the 6th IEEE International Conference on Computer and Information Technology (IEEE CIT 2006)_, p. 189, 2006. (**Best Paper Award**, [Journal Version](https://link.springer.com/article/10.1007/s11390-010-9398-x))
  > - Davy Landman, Alexander Serebrenik, Eric Bouwers, and Jurgen J. Vinju. [Empirical analysis of the relationship between CC and SLOC in a large corpus of Java methods and C functions](https://doi.org/10.1002/smr.1760). _Journal of Software: Evolution and Process_, 2016, 28(7): 589-618.
  > - Gábor Szárnyas, Zsolt Kővári, Ágnes Salánki, and Dániel Varró. [Towards the characterization of realistic models: evaluation of multidisciplinary graph metrics](https://doi.org/10.1145/2976767.2976786). In _Proceedings of the 19th ACM/IEEE International Conference on Model Driven Engineering Languages and Systems (MODELS 2016)_, pp. 87-94, 2016.
  > - Srdjan Stevanetic and Uwe Zdun. [Supporting the analyzability of architectural component models - empirical findings and tool support](https://doi.org/10.1007/s10664-017-9583-4). _Empirical Software Engineering_, 2018, 23(6): 3578-3625.
  ...
  > - Stefano Dalla Palma, Chiel van Asseldonk, Gemma Catolino, Dario Di Nucci, Fabio Palomba, and Damian A. Tamburri. [“Through the looking-glass …” An empirical study on blob infrastructure blueprints in the Topology and Orchestration Specification for Cloud Applications](https://doi.org/10.1002/smr.2533). _Journal of Software: Evolution and Process_,  10.1002/smr.2533, 2023.
- Jing Liu*, Keqing He, **Yutao Ma**, and Rong Peng. [Scale free in software metrics](https://ieeexplore.ieee.org/document/4020082). In _Proceedings of the 30th Annual International Computer Software and Applications Conference (COMPSAC 2006)_, vol. 1, pp. 229-235, 2006. 
  ...
  > - Miloš Savić, Mirjana Ivanović, and Lakhmi C. Jain. [Analysis of Software Networks](https://doi.org/10.1007/978-3-319-91196-0_3). In _Complex Networks in Software, Knowledge, and Social Systems_, pp. 59-141, 2019.
- **Yutao Ma**, Keqing He, and Dehui Du. [A qualitative method for measuring the structural complexity of software systems based on complex networks](https://ieeexplore.ieee.org/document/1607160). In _Proceedings of the 12th Asia-Pacific Software Engineering Conference (APSEC 2005)_, pp. 257-263, 2005.
  ...
  > - Pamela Bhattacharya, Marios Iliofotou, Iulian Neamtiu, and Michalis Faloutsos. [Graph-based analysis and prediction for software evolution](https://doi.org/10.1109/ICSE.2012.6227173). In _Proceedings of the 34th International Conference on Software Engineering (ICSE 2012)_, pp. 419-429, 2012.
  > - Gabriel Ferreira, Momin M. Malik, Christian Kästner, Jürgen Pfeffer, and Sven Apel. [Do #ifdefs influence the occurrence of vulnerabilities? an empirical study of the linux kernel](https://doi.org/10.1145/2934466.2934467). In _Proceedings of the 20th International Systems and Software Product Line Conference (SPLC 2016)_, pp. 65-73, 2016.
  > - Christos Ellinas, Neil Allan, and Anders Johansson. [Exploring Structural Patterns Across Evolved and Designed Systems: A Network Perspective](https://doi.org/10.1002/sys.21350). _Systems Engineering_, 2016, 19(3): 179-192.
...
| 2012 | [Peng He](http://cybersec.hubu.edu.cn/info/1251/1098.htm)<br>(Ph.D. Supervisor: Prof. Bing Li) | National Scholarship for postgraduates (2013, 2014) | [Hubei University](http://www.hubu.edu.cn/) |
| 2013 | [Hongrun Wu](https://wxxy.mnnu.edu.cn/info/1015/3019.htm)<br>(Ph.D. Supervisor: Prof. Deyi Li) | One-year exchange student at [Rovira i Virgili University](http://www.urv.cat/en/)<br>Short-term visiting student at [Indiana University](https://indiana.edu/) | [Minnan Normal University](http://www.mnnu.edu.cn/) |
